function MultiSelectTag(e, t = { shadow: !1, rounded: !0 }) { 
    ...
    function f(e) { 
        ...
        l.addEventListener("click", (t => { d.find((t => t.value == e.value)).selected = !1, g(e.value), h(), E() })), t.appendChild(n), t.appendChild(l), o.append(t) 
    } 
    function L() 
    { 
        for (var e of v.children) e.addEventListener("click", (e => { d.find((t => t.value == e.target.dataset.value)).selected = !0, r.value = null, h(), E(), r.focus() })) 
    } 
    function w(e) 
    { 
    ...
    function () 
    { 
        d = [...n.options].map((e => ({ value: e.value, label: e.label, selected: e.selected }))), 
        ...
        c.append(r), i.append(o), (s = document.createElement("div")).classList.add("btn-container"), 
